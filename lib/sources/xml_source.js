...
var XmlSource = exports.XmlSource = function (_SitemapTransformer) {
  ...
  function XmlSource(options) {
    ...
    var _this = _possibleConstructorReturn(this, (XmlSource.__proto__ || Object.getPrototypeOf(XmlSource)).call(this, options));

    var myConfig = (0, _lodash.extend)({}, DEFAULT_OPTIONS, options.options);
  ...
  _createClass(XmlSource, [{
    ...
    key: 'open',
    value: function open() {
      _get(XmlSource.prototype.__proto__ || Object.getPrototypeOf(XmlSource.prototype), 'open', this).call(this);
      if (this.inputStream) {
