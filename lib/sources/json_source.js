...
var JsonSource = exports.JsonSource = function (_SitemapTransformer) {
  ...
  function JsonSource(config) {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(JsonSource).call(this, config));
  ...
  _createClass(JsonSource, [{
    key: 'open',
    value: function open() {
      _get(Object.getPrototypeOf(JsonSource.prototype), 'open', this).call(this);
      if (this.inputStream) {
