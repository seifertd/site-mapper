...
var PaginatedHttpInput = exports.PaginatedHttpInput = function (_Readable) {
  ...
  function PaginatedHttpInput(options) {
    ...
    var _this = _possibleConstructorReturn(this, (PaginatedHttpInput.__proto__ || Object.getPrototypeOf(PaginatedHttpInput)).call(this));

    _this.baseUrl = _url2.default.parse(options.url, true);
    _this.pagination = (0, _lodash.extend)({}, DEFAULT_PAGINATION, options.pagination);
  ...
  _createClass(PaginatedHttpInput, [{
    ...
    value: function _startNextRequest() {
      ...
      var newUrl = (0, _lodash.extend)({}, this.baseUrl);
      ...
      _request2.default.get((0, _lodash.extend)({ encoding: 'binary' }, _config.config.httpOptions, this.httpOptions, { uri: url })).on('response', function (response) {
