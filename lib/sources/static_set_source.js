...
var StaticSetSource = exports.StaticSetSource = function (_SitemapTransformer) {
  ...
  function StaticSetSource(config) {
    ...
    return _possibleConstructorReturn(this, (StaticSetSource.__proto__ || Object.getPrototypeOf(StaticSetSource)).call(this, config));
  }

  _createClass(StaticSetSource, [{
    key: 'open',
    value: function open() {
      _get(StaticSetSource.prototype.__proto__ || Object.getPrototypeOf(StaticSetSource.prototype), 'open', this).call(this);
