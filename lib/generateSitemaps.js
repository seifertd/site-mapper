...
var generateSitemaps = function generateSitemaps(configOverrides, done) {
  ...
  _config.config.addOverrides(configOverrides);
  ...
  (0, _lodash.each)(_config.config.sitemaps, function (sitemapConfig, sitemapName) {
