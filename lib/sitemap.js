...
void function () {
  ...
  urlXml = function (url) {
    ...
    if (null != url.linkTags)
      for (var i$ = 0, length$ = url.linkTags.length; i$ < length$; ++i$) {
        linkTag = url.linkTags[i$];
  ...
  module.exports = Sitemap = function () {
    ...
    Sitemap.prototype.open = function () {
      ...
      this.gzipFinished = false;
      this.fileFinished = false;
      this.closed = false;
      this.gzipper = require('zlib').createGzip();
      sitemapThis = this;
      this.gzipper.on('finish', function () {
        return sitemapThis.gzipFinished = true;
      });
      this.file.on('finish', function () {
        return sitemapThis.fileFinished = true;
      });
    ...
    Sitemap.prototype.notifyWhenDone = function (cb) {
      ...
      return process.nextTick(function () {
        return async.until(function () {
          return sitemapThis.gzipFinished && sitemapThis.fileFinished;
        }, function (untilCb) {
