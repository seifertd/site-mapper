...
var Sitemap = exports.Sitemap = function (_Writable) {
  ...
  function Sitemap(_ref) {
    var source = _ref.source,
        sitemapConfig = _ref.sitemapConfig;

    _classCallCheck(this, Sitemap);

    var _this = _possibleConstructorReturn(this, (Sitemap.__proto__ || Object.getPrototypeOf(Sitemap)).call(this, { objectMode: true }));
  ...
  _createClass(Sitemap, [{
    ...
    value: function _write(url, encoding, callback) {
      ...
      var _currentSitemapFile = this.currentSitemapFile(channel),
          _currentSitemapFile2 = _slicedToArray(_currentSitemapFile, 2),
          file = _currentSitemapFile2[0],
          previousFile = _currentSitemapFile2[1];
