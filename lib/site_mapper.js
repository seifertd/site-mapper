...
var SiteMapper = exports.SiteMapper = function () {
  function SiteMapper(sitemapConfig) {
    ...
    this.sitemapConfig = (0, _lodash.extend)({}, _config.config.defaultSitemapConfig, sitemapConfig);
  ...
  _createClass(SiteMapper, [{
    ...
    value: function initializeSources() {
      ...
      (0, _lodash.each)(_config.config.sources, function (sourceDefinition, sourceName) {
