...
void function () {
  ...
  module.exports = Source = function (super$) {
    ...
    Source.prototype.generateUrls = function (cb) {
      return this._generateUrls(function (prefilteredUrl) {
        if (!this.urlFilter || this.urlFilter(prefilteredUrl))
          return cb(prefilteredUrl);
      });
    };
      ...
      return process.nextTick(function (this$) {
        return function () {
          ...
          if (!this$.options.ignoreErrors) {
            ...
            util = require('util');
            this$.out.write('[IGNORING ERROR]: ' + util.inspect(err) + ' by configuration\n');
            return this$.emit('done');
          }
        };
      }(this));
