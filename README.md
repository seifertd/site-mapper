...
and produce url objects from data of a specific format.  There are three included Source implementations:
  ...
  1.  XmlSource - Produces urls from XML data.
...
- relax\_column\_count: true if you don't want an error raised if the number of columns in the csv data is different from what is configured.
...
Out of the box, the XmlSource is configured to read sitemap.xml files. This is useful
if you have existing sitemaps or sitemaps generated by some other method that you
wish to include with sitemaps generated from other data sources.
